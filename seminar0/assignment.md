# 출처) 와플스튜디오 백엔드 세미나 과제 (저자: [변다빈](https://github.com/davin111))

### SNULife 2022 1학기 세미나 과제
...
- [Issues](https://github.com/snulife/backend-seminar/issues) 에 질문하는 것을 어려워하지 마시길 바랍니다!
